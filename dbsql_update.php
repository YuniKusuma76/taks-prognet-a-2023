<?php
    ...
    // proses update
    $sql = "UPDATE tb_bio_mhs SET
            nim ='$nim',nama_lengkap ='$nama_lengkap',jenis_kelamin ='$jenis_kelamin',fakultas ='$fakultas',prodi ='$prodi',tgl_lahir ='$tgl_lahir',email ='$email',hobi ='$hobi'
            WHERE nim ='$nim'";
    ...
    $sql = "SELECT * FROM tb_bio_mhs WHERE nim='$idtoupdate'";
